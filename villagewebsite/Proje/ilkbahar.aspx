<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ilkbahar.aspx.cs" Inherits="ilkbahar" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="asilfoto">
       ...
       <asp:datalist ID="lstresimler" runat="server" RepeatColumns="3" Width="725px" BorderStyle="Solid" CellSpacing="10" BackColor="Black" CaptionAlign="Right" CellPadding="10" CssClass="datacss">
            ...
            <itemtemplate>
                <div ">
                    <a id="imageLink" href='<%# Eval("ilkbaharyol") %>' rel="lightbox[Brussels]" runat="server">
                    <asp:Image CssClass="img" ImageUrl='<%#Eval("ilkbaharyol") %>' runat="server" Width="200" Height="150" BorderStyle="NotSet" BorderColor="Silver" />
                        </a>
                </div>
            </itemtemplate>
