<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="sonbahar.aspx.cs" Inherits="sonbahar" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="asilfoto">
       ...
       <div style="height:1310px; overflow:auto;" >
            ...
            <itemtemplate>
                <div ">
                    <a id="imageLink" href='<%# Eval("sonbaharyol") %>' rel="lightbox[Brussels]" runat="server">
                    <asp:Image CssClass="img" ImageUrl='<%#Eval("sonbaharyol") %>' runat="server" Width="200" Height="150" BorderStyle="NotSet" BorderColor="Silver" />
                    </a>
                </div>
            </itemtemplate>
